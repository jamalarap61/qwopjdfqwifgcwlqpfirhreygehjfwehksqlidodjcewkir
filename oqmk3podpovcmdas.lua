...
if not isfolder("ZeroImpact/Config") then
    makefolder("ZeroImpact/Config")
end
...
if getgenv().ZeroImpactWindowHash and RobloxGui:FindFirstChild(getgenv().ZeroImpactWindowHash) then
    RobloxGui[getgenv().ZeroImpactWindowHash]:Destroy()
end
if getgenv().ZeroImpactToggleHash and RobloxGui:FindFirstChild(getgenv().ZeroImpactToggleHash) then
    RobloxGui[getgenv().ZeroImpactToggleHash]:Destroy()
end
if getgenv().ZeroImpactNotifyHash and RobloxGui:FindFirstChild(getgenv().ZeroImpactNotifyHash) then
    RobloxGui[getgenv().ZeroImpactNotifyHash]:Destroy()
end

getgenv().ZeroImpactWindowHash = generateHash(12)
getgenv().ZeroImpactToggleHash = generateHash(12)
getgenv().ZeroImpactNotifyHash = generateHash(12)

local windowName = getgenv().ZeroImpactWindowHash
local toggleName = getgenv().ZeroImpactToggleHash
local notifyName = getgenv().ZeroImpactNotifyHash
...
function ZeroImpact:MakeNotify(NotifyConfig)
    ...
    NotifyConfig.Color = NotifyConfig.Color or Color3.fromRGB(0, 180, 255)
    ...
    spawn(function()
        ...
        if not ActualNotifyGui:FindFirstChild("NotifyLayout") then
            ...
            NotifyLayout.Parent = ActualNotifyGui
            local Count = 0
            ActualNotifyGui.NotifyLayout.ChildRemoved:Connect(function()
                Count = 0
                for i, v in ActualNotifyGui.NotifyLayout:GetChildren() do
                    TweenService:Create(
                        v,
        ...
        NotifyFrame.BackgroundColor3 = Color3.fromRGB(15, 22, 33)
        NotifyFrame.BorderColor3 = Color3.fromRGB(15, 22, 33)
        NotifyFrame.BorderSizePixel = 0
        NotifyFrame.Size = UDim2.new(1, 0, 0, 150)
        NotifyFrame.Name = "NotifyFrame"
        NotifyFrame.BackgroundTransparency = 1
        NotifyFrame.Parent = ActualNotifyGui.NotifyLayout
...
function ZeroImpact:Window(GuiConfig)
    ...
    local ZeroImpactOnTop = Instance.new("ScreenGui");
    local DropShadowHolder = Instance.new("Frame");
    local DropShadow = Instance.new("ImageLabel");
    ...
    ZeroImpactOnTop.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    ZeroImpactOnTop.Name = windowName
    ZeroImpactOnTop.ResetOnSpawn = false
    ZeroImpactOnTop.Parent = RobloxGui
    ...
    Close.Activated:Connect(function()
        ...
        Yes.MouseButton1Click:Connect(function()
            if ZeroImpactOnTop then ZeroImpactOnTop:Destroy() end
            if RobloxGui:FindFirstChild(toggleName) then
                RobloxGui[toggleName]:Destroy()
            end
        end)
    ...
    DropdownSelect.BackgroundColor3 = Color3.fromRGB(12, 16, 24)
    ...
    DropdownSelectReal.BackgroundColor3 = Color3.fromRGB(12, 16, 24) -- Latar Warna Dropdown
    ...
    function Tabs:AddTab(TabConfig)
        ...
        function Sections:AddSection(Title, AlwaysOpen)
            ...
            function Items:AddParagraph(ParagraphConfig)
                ...
                Paragraph.BackgroundColor3 = Color3.fromRGB(20, 28, 40)
            ...
            function Items:AddButton(ButtonConfig)
                ...
                MainButton.BackgroundColor3 = Color3.fromRGB(20, 28, 40)
            ...
            function Items:AddToggle(ToggleConfig)
                ...
                Toggle.BackgroundColor3 = Color3.fromRGB(20, 28, 40)
            ...
            function Items:AddSlider(SliderConfig)
                ...
                Slider.BackgroundColor3 = Color3.fromRGB(20, 28, 40)
            ...
            function Items:AddInput(InputConfig)
                ...
                Input.BackgroundColor3 = Color3.fromRGB(20, 28, 40)
            ...
            function Items:AddDropdown(DropdownConfig)
                ...
                Dropdown.BackgroundColor3 = Color3.fromRGB(20, 28, 40)
                ...
                SearchBox.BackgroundColor3 = Color3.fromRGB(12, 16, 24)
