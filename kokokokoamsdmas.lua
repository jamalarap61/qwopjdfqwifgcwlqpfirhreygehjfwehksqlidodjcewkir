...
local function CloseOpen()
	...
	Close_ImageButton.BackgroundColor3 = Color3.fromRGB(10, 10, 40)
	...
	Close_ImageButton.Image = "rbxassetid://88478059953821" --98235895490170 | 123767073052336 | 102794753447548
...
ElementsTable.Button = (function()
	...
	function Element:New(Config)
		...
		local ButtonIco = New("ImageLabel", {
			Image = "rbxassetid://83063565598700",
...
local InterfaceManager = {} do
	...
	function InterfaceManager:SaveSettings()
		writefile(self.Folder .. "/limithub.json", httpService:JSONEncode(InterfaceManager.Settings))
	end

	function InterfaceManager:LoadSettings()
		local path = self.Folder .. "/limithub.json"
		if isfile(path) then
